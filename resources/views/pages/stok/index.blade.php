    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-sm btn-primary mt-1" href="{{ url('stok/create') }}"><i
                        class="bi bi-plus-lg mr-3"></i>Tambah</a>
            </div>
        </div>
        <div class="card-body">
            @if (session('success'))
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col">
                                            ...
                                            <small class="form-text text-muted">Bulan Stok</small>
                                        </div>
                                        <div class="col">
                                            ...
                                            <small class="form-text text-muted">Tahun Stok</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            var dataUser = $('#tabel_stok').DataTable({
                serverSide: true,
                ajax: {
                    "url": "{{ url('stok/list') }}",
                    "dataType": "json",
