        ...
        <form method="POST" action="{{ url('transaksi') }}" class="form-horizontal">
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="penjualan_kode" name="penjualan_kode" value="{{ $kodePenjualan }}" readonly>
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col">
                        <input type="date" class="form-control" id="penjualan_tanggal" name="penjualan_tanggal" value="{{ old('penjualan_tanggal') ?? $today }}" required>
            ...
            <div class="form-group detail-transaksi">
                <div class="form-group mt-3 form-barang bg-light p-3 rounded">
                    <div class="row">
                        <div class="col">
                            <div class="col">
                                <button class="delete-card-button btn btn-danger btn-sm float-right" onclick="deleteCard(this)" type="button"><i class="bi bi-trash mr-2"></i>Hapus
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col">
                                <input type="text" class="form-control jumlah" id="jumlah" name="jumlah[]" value="{{ old('jumlah') }}" required placeholder="Min. 1">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col">
                                <input type="text" class="form-control harga" id="harga" value="{{ old('total') }}" readonly>
                                @error('harga')
                                <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col">
                                @php
                                $total = $barang->barang_harga * old('jumlah');
                                @endphp
                                <input type="text" class="form-control total" id="total" name="harga[]" value="{{ old('total') }}" readonly>
                                @error('harga')
                                <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
            ...
            <div class="col-sm-6">
                <button class="add-new-product btn btn-primary btn-sm" type="button" disabled><i class="bi bi-plus-lg mr-2"></i>Tambah Barang</button>
            </div>
            <div class="col-sm-6 pt-5">
                <button type="submit" class="btn btn-primary btn-sm save" disabled><i class="bi bi-floppy mr-2"></i>Simpan</button>
                <a class="btn btn-sm btn-default ml-1" href="{{ url('transaksi') }}"><i class="bi bi-arrow-90deg-left mr-2"></i>Kembali</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    const fetchData = async (id) => {
        try {
            barang = await $.get(`/api/barang/${id}/get`, function(response) {
